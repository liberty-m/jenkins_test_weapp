	...
	<view>
		...
		<view class="main">
			...
			<view class="align-between mt-60">
				...
				<view class="pri-c fz-28 mr-20" @tap="toBackLogin">登录</view>
			</view>
			<view class="flex-align mt-30">
				<image class="icon-before" src="../../static/icon/phone.png" alt="" />
				<input v-model="account" :disabled="!agreement" class="phone-input" placeholder="请输入手机号" type="number" />
			</view>
			<view class="flex-align mt-30">
				...
				<input
					...
					:disabled="!agreement"
					v-model="password"
					class="uni-input-input phone-input"
					placeholder="请输入密码"
					type="password"
				/>
			...
			<view class="flex-align mt-30">
				<image class="icon-before" src="../../static/icon/phone.png" alt="" />
				<input v-model="name" :disabled="!agreement" class="phone-input" placeholder="请输入姓名" />
			</view>
			<view class="mt-60 mb-10"><button type="default" class="phohe-login" @tap="toRegistry">注册</button></view>
			...
			<view class="text-center mt-80">
				...
				<button class="wx-btn" v-if="agreement" open-type="getPhoneNumber" @getphonenumber="getPhone" type="default">
					<img class="wx-icon" src="../../static/wx.png" alt="" />
				</button>
