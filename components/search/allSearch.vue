<template>
    <view class="serach" :style="!showMask ? 'padding: 0 40rpx' : 'padding: 0 80rpx'">
		<u-picker :show="showPicker" :columns="selectList" confirmColor="#BC292D" closeOnClickOverlay keyName="label" @confirm="confirm" @close="showPicker = false" @cancel="showPicker = false" ></u-picker>
            ...
            <view class="content-box">
                ...
                <view class="seach-select" v-if="selectList.length>0">
                    ...
                    <view class="select-value" @click="selectClick">
                        <text class="pr-10" style="font-size: 14px;">{{inSelectValue.label}}</text>
		...
		<view @click="cancel" v-if="!showMask" class="search-cancel">取消</view>
...
<script>
	import { saveHistoryList,getHistoryList } from '@/common/function/searchHistoryList.js'
    export default {
        props: {
            selectList: {
                type: Array,
    ...
    //         },
            ...
            triggerConfirm() {
				...
				saveHistoryList({id:searchQuery.selectIndex,text:searchQuery.keyword})
